...
data class TextKeyboard(
    ...
    data class TextKey(
        ...
        companion object {
            fun decode(node: Node.Mapping): TextKey = TextKey(
                ...
                labelLeft = node["label_left"]?.string ?: "",
                labelRight = node["label_right"]?.string ?: "",
                labelDown = node["label_down"]?.string ?: "",
    ...
    companion object {
        fun decode(node: Node.Mapping): TextKeyboard = TextKeyboard(
            ...
            hideInputBar = node["hide_input_bar"]?.boolean ?: false,
